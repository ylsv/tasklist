...
function getTasks(){
  let tasks;
  if(localStorage.getItem('tasks') === null) { // checks if there's anythin in LS already
    tasks = [];
  } else {
...
function filterTasks(e) {
  ...
  document.querySelectorAll('.collection-item').forEach(function(task){
    ...
    if(item.toLowerCase().indexOf(text) != -1){ // checks if the item is present at all in the list
